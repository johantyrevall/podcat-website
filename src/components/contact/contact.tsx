...
function Contact() {
    return (
        <div id='contact' className='flex flex-col items-center h-screen bg-[#F0F0F0]'>
            <div className='w-4/5'>
                ...
                <div className='flex flex-row justify-between items-center w-full'>
                    <div className='border-1 border-gray-300 rounded-xl w-4xl h-150 bg-white '>
                        ...
                        <input className='border-1 border-gray-300 rounded-xl h-12 m-3 text-xl px-4' placeholder='Epost eller telefon*' />
                        <textarea
                            id='meddelande'
                            className='border-1 border-gray-300 rounded-xl min-h-[100px] max-h-[390px] m-3 text-xl px-4 py-2 resize-y'
