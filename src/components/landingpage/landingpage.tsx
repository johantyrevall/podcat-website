  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen bg-[#E9EBF8]'>
      ...
      <div className='flex flex-row gap-x-8 h-24 m-3'>
        <button className='bg-[#0000FF] text-white font-semibold rounded-full h-12 w-55'>Så kan vi hjälpa dig</button>
        <button className='bg-[#DBDBDB] font-semibold rounded-full h-12 w-55'>Kontakta oss</button>
      </div>
      <FontAwesomeIcon icon={faArrowDown} beatFade size='2x' style={{color: "#000000"}} />
    </div>
  );
}
