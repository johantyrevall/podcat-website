    ...
    <div id='services' className='px-4 md:px-50 min-h-screen py-10 md:py-20'>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center md:mt-10'>
        {services.map((service) => (
          <div
            key={service.title}
            className='flex flex-col items-center justify-start m-3 w-full md:w-[400px] h-auto md:h-[500px] pt-6 md:pt-10'
            data-aos='fade-up'
          >
            <FontAwesomeIcon icon={service.icon} className={service.iconClass} />
            <h2 className='text-2xl md:text-3xl font-medium m-1 md:mb-3'>{service.title}</h2>
